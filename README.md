...
- **Mermaid Bubbles** (all ages) — A little mermaid swims gently through an underwater scene with sand, seaweed, a starfish and a crab. Bubbles rise from the seabed — **tap them to pop** (the mermaid also pops any she swims into). Coloured shells rest on the sand; **tap a shell to collect it** into the tray at the top, which counts pink, purple, green, yellow and blue.
